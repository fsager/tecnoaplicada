...
public class PanelPersona extends javax.swing.JPanel implements Finalisable {
	...
	public void btnTomarExamen() {
		final JInternalFrameTesterGral internalframe = new JInternalFrameTesterGral("Tomar Exámen", false, false, false, false);

		PanelTomarExamen panelTomarExamen = new PanelTomarExamen(persona,menu,internalframe);
		internalframe.add(panelTomarExamen);
		internalframe.pack();
