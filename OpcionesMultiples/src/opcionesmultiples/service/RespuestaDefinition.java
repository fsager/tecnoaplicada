 ...
 * @version 1.0
 */
public interface RespuestaDefinition {
	 ...
	 */
	public abstract void delete(Respuesta p_domain) throws Exception;
	 ...
	 */
	public abstract Respuesta get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Respuesta p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Respuesta p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Respuesta p_domain) throws Exception;
