 ...
 * @version 1.0
 */
public interface ClaseLicenciaDefinition {
	 ...
	 */
	public abstract void delete(ClaseLicencia p_domain) throws Exception;
	 ...
	 */
	public abstract ClaseLicencia get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(ClaseLicencia p_example) throws Exception;
	 ...
	 */
	public abstract void insert(ClaseLicencia p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(ClaseLicencia p_domain) throws Exception;
