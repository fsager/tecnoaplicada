 ...
 * @version 1.0
 */
public interface PermisoDefinition {
	 ...
	 */
	public abstract void delete(Permiso p_domain) throws Exception;
	 ...
	 */
	public abstract Permiso get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Permiso p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Permiso p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Permiso p_domain) throws Exception;
