 ...
 * @version 1.0
 */
public interface UsuarioExamenDefinition {
	 ...
	 */
	public abstract void delete(UsuarioExamen p_domain) throws Exception;
	 ...
	 */
	public abstract UsuarioExamen get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(UsuarioExamen p_example) throws Exception;
	 ...
	 */
	public abstract void insert(UsuarioExamen p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(UsuarioExamen p_domain) throws Exception;
