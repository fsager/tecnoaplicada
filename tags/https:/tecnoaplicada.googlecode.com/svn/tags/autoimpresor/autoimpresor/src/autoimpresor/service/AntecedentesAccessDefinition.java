 ...
 * @version 1.0
 */
public interface AntecedentesAccessDefinition {
	 ...
	 */
	public abstract void delete(Antecedentes p_domain) throws Exception;
	 ...
	 */
	public abstract Antecedentes get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Antecedentes p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Antecedentes p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Antecedentes p_domain) throws Exception;
