 ...
 * @version 1.0
 */
public interface LocalidadesAccessDefinition {
	 ...
	 */
	public abstract void delete(Localidades p_domain) throws Exception;
	 ...
	 */
	public abstract Localidades get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Localidades p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Localidades p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Localidades p_domain) throws Exception;
