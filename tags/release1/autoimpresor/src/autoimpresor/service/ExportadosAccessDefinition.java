 ...
 * @version 1.0
 */
public interface ExportadosAccessDefinition {
	 ...
	 */
	public abstract void delete(Exportados p_domain) throws Exception;
	 ...
	 */
	public abstract Exportados get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Exportados p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Exportados p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Exportados p_domain) throws Exception;
