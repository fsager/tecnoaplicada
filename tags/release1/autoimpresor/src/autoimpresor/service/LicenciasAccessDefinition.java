 ...
 * @version 1.0
 */
public interface LicenciasAccessDefinition {
	 ...
	 */
	public abstract void delete(Licencias p_domain) throws Exception;
	 ...
	 */
	public abstract Licencias get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Licencias p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Licencias p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Licencias p_domain) throws Exception;
