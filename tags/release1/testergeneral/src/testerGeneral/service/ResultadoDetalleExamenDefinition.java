 ...
 * @version 1.0
 */
public interface ResultadoDetalleExamenDefinition {
	 ...
	 */
	public abstract void delete(ResultadoDetalleExamen p_domain) throws Exception;
	 ...
	 */
	public abstract ResultadoDetalleExamen get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(ResultadoDetalleExamen p_example) throws Exception;
	 ...
	 */
	public abstract void insert(ResultadoDetalleExamen p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(ResultadoDetalleExamen p_domain) throws Exception;
