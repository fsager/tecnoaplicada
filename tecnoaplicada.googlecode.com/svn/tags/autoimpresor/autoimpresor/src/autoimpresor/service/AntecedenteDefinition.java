 ...
 * @version 1.0
 */
public interface AntecedenteDefinition {
	 ...
	 */
	public abstract void delete(Antecedente p_domain) throws Exception;
	 ...
	 */
	public abstract Antecedente get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Antecedente p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Antecedente p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Antecedente p_domain) throws Exception;
