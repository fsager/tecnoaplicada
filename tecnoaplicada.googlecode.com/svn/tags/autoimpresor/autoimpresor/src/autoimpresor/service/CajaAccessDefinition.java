 ...
 * @version 1.0
 */
public interface CajaAccessDefinition {
	 ...
	 */
	public abstract void delete(Caja p_domain) throws Exception;
	 ...
	 */
	public abstract Caja get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Caja p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Caja p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Caja p_domain) throws Exception;
