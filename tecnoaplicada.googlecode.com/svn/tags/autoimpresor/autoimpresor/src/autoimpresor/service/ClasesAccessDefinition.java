 ...
 * @version 1.0
 */
public interface ClasesAccessDefinition {
	 ...
	 */
	public abstract void delete(Clases p_domain) throws Exception;
	 ...
	 */
	public abstract Clases get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Clases p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Clases p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Clases p_domain) throws Exception;
