 ...
 * @version 1.0
 */
public interface ClienteDefinition {
	 ...
	 */
	public abstract void delete(Cliente p_domain) throws Exception;
	 ...
	 */
	public abstract Cliente get(java.io.Serializable p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Cliente p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Cliente p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Cliente p_domain) throws Exception;
