package ar.com.tecnologiaaplicada.service;
 ...
 * @version 1.0
 */
public interface DetalleLicenciaDefinition {
	 ...
	 */
	public abstract void delete(DetalleLicencia p_domain) throws Exception;
	 ...
	 */
	public abstract DetalleLicencia get(java.io.Serializable p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(DetalleLicencia p_example) throws Exception;
	 ...
	 */
	public abstract void insert(DetalleLicencia p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(DetalleLicencia p_domain) throws Exception;
