 ...
 * @version 1.0
 */
public interface DominioDefinition {
	 ...
	 */
	public abstract void delete(Dominio p_domain) throws Exception;
	 ...
	 */
	public abstract Dominio get(java.io.Serializable p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Dominio p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Dominio p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Dominio p_domain) throws Exception;
