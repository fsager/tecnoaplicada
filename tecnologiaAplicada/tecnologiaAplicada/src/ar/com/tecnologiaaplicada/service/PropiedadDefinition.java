 ...
 * @version 1.0
 */
public interface PropiedadDefinition {
	 ...
	 */
	public abstract void delete(Propiedad p_domain) throws Exception;
	 ...
	 */
	public abstract Propiedad get(java.io.Serializable p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Propiedad p_example) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Propiedad p_domain) throws Exception;
