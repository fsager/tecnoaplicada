...
INSERT INTO APP.EXAMEN (EXA_ID,EXA_CODIGO,EXA_NOMBRE,EXA_ORDEN) VALUES(5,'EXA_TEORICO','Examen Teórico',5);
i
...
nsert into "APP"."USUARIO_EXAMEN"("EXA_ID","USR_NOMBRE") values ((select exa_id from APP.EXAMEN where EXA_CODIGO = 'EXA_TEORICO'),'Administrador Sistema');


INSERT INTO APP.EXAMEN_DETALLE (EXAD_DETALLE,EXAD_CODIGO,EXA_ID,EXAD_ORDEN,EXAD_PARAMETROS_CORRECCION,EXAD_LICENCED)
 VALUES('Test Teórico','TEST_TEORICO',5,1,'','S');
