...
import opcionesmultiples.business.PreguntaBizImpl;
...
import frontend.paneles.PanelInformesYEstadisticas;
import frontend.paneles.PanelLogEventos;
import frontend.paneles.PanelMenu;
import frontend.paneles.PanelPanelDeControl;
...
public class PanelMenuPrincipal extends PanelMenu {
	...
	public void cargarExamenMultiplesChoice(PersonaExamen personaExamen,List<PreguntaInterfaz> preguntas) {
	...
	public void cargarSubAdmGral() {
		...
		*/
		...
		btnExamen.setVisible(true);
		toolbarSubNivel.add(btnExamen);

		btnPreguntas.setVisible(true);
		toolbarSubNivel.add(btnPreguntas);
	...
	public void seleccionarPreguntas() {
		...
		testerGeneral.persistence.impl.Util.insertAudit("Ingresó al Menú Preguntas", null,null);

		unSelectButtons(toolbarSubNivel, btnPreguntas);
		panelContenido.removeAll();

		PanelPreguntas panelPreguntas= new PanelPreguntas();
		panelPreguntas.setVisible(true);

		panelContenido.add(panelPreguntas);
	...
	public void seleccionarExamen() {
		...
		testerGeneral.persistence.impl.Util.insertAudit("Ingresó al Menú Examenes", null,null);

		unSelectButtons(toolbarSubNivel, btnExamen);
		panelContenido.removeAll();

		Dominio dom = new Dominio();
		dom.setDomClave(Constantes.DOMINIO_CLAVE_MP_CATEGORIA_EXAMEN);
		dom.setDomTipo(Constantes.DOMINIO_TIPO_MP_CATEGORIA_EXAMEN);
		
		PanelDominio panelDominios = new PanelDominio(dom);
		panelDominios.setVisible(true);
		panelContenido.add(panelDominios);
	...
	private javax.swing.JToggleButton btnExamen = new JToggleButton("Examenes");
	
	private javax.swing.JToggleButton btnPreguntas = new JToggleButton("Preguntas");
