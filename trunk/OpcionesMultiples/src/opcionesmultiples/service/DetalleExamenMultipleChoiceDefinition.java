package opcionesmultiples.service;
 ...
 * @version 1.0
 */
public interface DetalleExamenMultipleChoiceDefinition {
	 ...
	 */
	public abstract void delete(DetalleExamenMultipleChoice p_domain) throws Exception;
	 ...
	 */
	public abstract DetalleExamenMultipleChoice get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(DetalleExamenMultipleChoice p_example) throws Exception;
	 ...
	 */
	public abstract void insert(DetalleExamenMultipleChoice p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(DetalleExamenMultipleChoice p_domain) throws Exception;
