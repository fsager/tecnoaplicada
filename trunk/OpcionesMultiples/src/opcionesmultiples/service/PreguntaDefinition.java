 ...
 * @version 1.0
 */
public interface PreguntaDefinition {
	 ...
	 */
	public abstract void delete(Pregunta p_domain) throws Exception;
	 ...
	 */
	public abstract Pregunta get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Pregunta p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Pregunta p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Pregunta p_domain) throws Exception;
