 ...
 * @version 1.0
 */
public interface LicenciaDefinition {
	 ...
	 */
	public abstract void delete(Licencia p_domain) throws Exception;
	 ...
	 */
	public abstract Licencia get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Licencia p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Licencia p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Licencia p_domain) throws Exception;
	
	
	public abstract Long getMaxNumeroLicencia() throws Exception;
