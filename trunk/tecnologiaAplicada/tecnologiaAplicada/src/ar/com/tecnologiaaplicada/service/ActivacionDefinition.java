 ...
 * @version 1.0
 */
public interface ActivacionDefinition {
	 ...
	 */
	public abstract void delete(Activacion p_domain) throws Exception;
	 ...
	 */
	public abstract Activacion get(java.io.Serializable p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Activacion p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Activacion p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Activacion p_domain) throws Exception;
