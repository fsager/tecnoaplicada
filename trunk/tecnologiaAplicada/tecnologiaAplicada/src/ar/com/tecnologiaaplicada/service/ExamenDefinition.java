 ...
 * @version 1.0
 */
public interface ExamenDefinition {
	 ...
	 */
	public abstract void delete(Examen p_domain) throws Exception;
	 ...
	 */
	public abstract Examen get(java.io.Serializable p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Examen p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Examen p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Examen p_domain) throws Exception;
