 ...
 * @version 1.0
 */
public interface ResultadoDefinition {
	 ...
	 */
	public abstract void delete(Resultado p_domain) throws Exception;
	 ...
	 */
	public abstract Resultado get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(Resultado p_example) throws Exception;
	 ...
	 */
	public abstract void insert(Resultado p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(Resultado p_domain) throws Exception;
