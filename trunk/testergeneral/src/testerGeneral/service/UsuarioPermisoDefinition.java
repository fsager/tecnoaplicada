 ...
 * @version 1.0
 */
public interface UsuarioPermisoDefinition {
	 ...
	 */
	public abstract void delete(UsuarioPermiso p_domain) throws Exception;
	 ...
	 */
	public abstract UsuarioPermiso get(Long p_Id) throws Exception;
	 ...
	 */
	public abstract java.util.List getAll(UsuarioPermiso p_example) throws Exception;
	 ...
	 */
	public abstract void insert(UsuarioPermiso p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(UsuarioPermiso p_domain) throws Exception;
